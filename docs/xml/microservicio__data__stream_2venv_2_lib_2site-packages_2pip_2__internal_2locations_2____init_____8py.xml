...
<doxygen xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="compound.xsd" version="1.15.0" xml:lang="es">
  <compounddef id="microservicio__data__stream_2venv_2_lib_2site-packages_2pip_2__internal_2locations_2____init_____8py" kind="file" language="Python">
...
<codeline lineno="46"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal">_should_use_sysconfig()<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="60"><highlight class="normal">_USE_SYSCONFIG<sp/>=<sp/>_should_use_sysconfig()</highlight></codeline>
...
<codeline lineno="76"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal">_looks_like_bpo_44860()<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="101"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a9aed01544501d53d6876a159c5634637" kindref="member">_looks_like_red_hat_lib</ref>()<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="110"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">and</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a71193c8a5934fe3120cf20a9ff5ce0e9" kindref="member">_looks_like_red_hat_patched_platlib_purelib</ref>(INSTALL_SCHEMES[k])</highlight></codeline>
...
<codeline lineno="116"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a0c79826b48c8b1641ca0949d082deb49" kindref="member">_looks_like_debian_scheme</ref>()<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="124"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a0a8397fce252ef5f4ec2d5529be18cc3" kindref="member">_looks_like_red_hat_scheme</ref>()<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="144"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1ac4d75af7eb4f4b77ea1fedf1f931994e" kindref="member">_looks_like_slackware_scheme</ref>()<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="160"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1aa22a8290973b4129a7ed3c3863dfc5e0" kindref="member">_looks_like_msys2_mingw_scheme</ref>()<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="177" refid="namespacepip_1_1__internal_1_1locations_1a291bac702c7a4dbc58a8cfcf91d1fde2" refkind="member"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a291bac702c7a4dbc58a8cfcf91d1fde2" kindref="member">_fix_abiflags</ref>(parts:<sp/>Tuple[str])<sp/>-&gt;<sp/>Generator[str,<sp/></highlight><highlight class="keywordtype">None</highlight><highlight class="normal">,<sp/></highlight><highlight class="keywordtype">None</highlight><highlight class="normal">]:</highlight></codeline>
...
<codeline lineno="204"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1acf6163e29aa3b69b0aa47c06f0275efb" kindref="member">_warn_if_mismatch</ref>(old:<sp/>pathlib.Path,<sp/>new:<sp/>pathlib.Path,<sp/>*,<sp/>key:<sp/>str)<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="207"><highlight class="normal"><sp/><sp/><sp/><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a6b375d8f51301911772e044f4b0afae8" kindref="member">_warn_mismatched</ref>(old,<sp/>new,<sp/>key=key)</highlight></codeline>
...
<codeline lineno="296"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/>k<sp/>==<sp/></highlight><highlight class="stringliteral">&quot;platlib&quot;</highlight><highlight class="normal"><sp/></highlight><highlight class="keywordflow">and</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a9aed01544501d53d6876a159c5634637" kindref="member">_looks_like_red_hat_lib</ref>():</highlight></codeline>
...
<codeline lineno="309"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">and</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a67fed6eb46d692e1dac3f4266d0b3e31" kindref="member">_looks_like_bpo_44860</ref>()</highlight></codeline>
...
<codeline lineno="320"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">and</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1ac4d75af7eb4f4b77ea1fedf1f931994e" kindref="member">_looks_like_slackware_scheme</ref>()</highlight></codeline>
...
<codeline lineno="353"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>WINDOWS<sp/></highlight><highlight class="keywordflow">and</highlight><highlight class="normal"><sp/>k<sp/></highlight><highlight class="keywordflow">in</highlight><highlight class="normal"><sp/>(</highlight><highlight class="stringliteral">&quot;platlib&quot;</highlight><highlight class="normal">,<sp/></highlight><highlight class="stringliteral">&quot;purelib&quot;</highlight><highlight class="normal">)<sp/></highlight><highlight class="keywordflow">and</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1aa22a8290973b4129a7ed3c3863dfc5e0" kindref="member">_looks_like_msys2_mingw_scheme</ref>()</highlight></codeline>
...
<codeline lineno="402"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a6b375d8f51301911772e044f4b0afae8" kindref="member">_warn_mismatched</ref>(old_v,<sp/>new_v,<sp/>key=key)</highlight></codeline>
<codeline lineno="403"><highlight class="normal"><sp/><sp/><sp/><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a34e0b355dc896099269fc119588e2c84" kindref="member">_log_context</ref>(user=user,<sp/>home=home,<sp/>root=root,<sp/>prefix=prefix)</highlight></codeline>
...
<codeline lineno="408"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a16778e3cdfe90ef299023b6859496e71" kindref="member">get_bin_prefix</ref>()<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="414"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1acf6163e29aa3b69b0aa47c06f0275efb" kindref="member">_warn_if_mismatch</ref>(pathlib.Path(old),<sp/>pathlib.Path(new),<sp/>key=</highlight><highlight class="stringliteral">&quot;bin_prefix&quot;</highlight><highlight class="normal">):</highlight></codeline>
<codeline lineno="415"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a34e0b355dc896099269fc119588e2c84" kindref="member">_log_context</ref>()</highlight></codeline>
...
<codeline lineno="419"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1add0b2f0c98d3d2dab8ed1a7f805f9ee6" kindref="member">get_bin_user</ref>()<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="423"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a9db0aab3646b079022b8c066eef1d0ee" kindref="member">_looks_like_deb_system_dist_packages</ref>(value:<sp/>str)<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="433"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/></highlight><highlight class="keywordflow">not</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a0c79826b48c8b1641ca0949d082deb49" kindref="member">_looks_like_debian_scheme</ref>():</highlight></codeline>
...
<codeline lineno="440"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a12039e29a27a8da5b7ed82efd881bd05" kindref="member">get_purelib</ref>()<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="447"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a9db0aab3646b079022b8c066eef1d0ee" kindref="member">_looks_like_deb_system_dist_packages</ref>(old):</highlight></codeline>
...
<codeline lineno="449"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1acf6163e29aa3b69b0aa47c06f0275efb" kindref="member">_warn_if_mismatch</ref>(pathlib.Path(old),<sp/>pathlib.Path(new),<sp/>key=</highlight><highlight class="stringliteral">&quot;purelib&quot;</highlight><highlight class="normal">):</highlight></codeline>
<codeline lineno="450"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a34e0b355dc896099269fc119588e2c84" kindref="member">_log_context</ref>()</highlight></codeline>
...
<codeline lineno="454"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1locations_1a037c86df8fd57df1da2fc3118f2ec766" kindref="member">get_platlib</ref>()<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="463"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a9db0aab3646b079022b8c066eef1d0ee" kindref="member">_looks_like_deb_system_dist_packages</ref>(old):</highlight></codeline>
...
<codeline lineno="465"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1acf6163e29aa3b69b0aa47c06f0275efb" kindref="member">_warn_if_mismatch</ref>(pathlib.Path(old),<sp/>pathlib.Path(new),<sp/>key=</highlight><highlight class="stringliteral">&quot;platlib&quot;</highlight><highlight class="normal">):</highlight></codeline>
<codeline lineno="466"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><ref refid="namespacepip_1_1__internal_1_1locations_1a34e0b355dc896099269fc119588e2c84" kindref="member">_log_context</ref>()</highlight></codeline>
<codeline lineno="467"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>old</highlight></codeline>
    ...
    <location file="microservicio_data_stream/venv/Lib/site-packages/pip/_internal/locations/__init__.py"/>
  </compounddef>
</doxygen>

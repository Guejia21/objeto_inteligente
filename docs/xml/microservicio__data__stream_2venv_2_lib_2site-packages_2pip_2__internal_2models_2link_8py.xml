...
<doxygen xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="compound.xsd" version="1.15.0" xml:lang="es">
  <compounddef id="microservicio__data__stream_2venv_2_lib_2site-packages_2pip_2__internal_2models_2link_8py" kind="file" language="Python">
...
<codeline lineno="45"><highlight class="normal"></highlight><highlight class="keyword">class<sp/></highlight><highlight class="normal">LinkHash:</highlight></codeline>
...
<codeline lineno="69"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal">__post_init__(self)<sp/>-&gt;<sp/>None:</highlight></codeline>
<codeline lineno="70"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">assert</highlight><highlight class="normal"><sp/>self.name<sp/></highlight><highlight class="keywordflow">in</highlight><highlight class="normal"><sp/>_SUPPORTED_HASHES</highlight></codeline>
...
<codeline lineno="76"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>match<sp/>=<sp/>cls.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_hash_1a24256879f4c80a2a3a6d98b920637c11" kindref="member">_hash_url_fragment_re</ref>.search(url)</highlight></codeline>
...
<codeline lineno="87"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/><ref refid="classpip_1_1__internal_1_1utils_1_1hashes_1_1_hashes" kindref="compound">Hashes</ref>({self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_hash_1ae7e414a393542b28b4075a89772f0dac" kindref="member">name</ref>:<sp/>[self.value]})</highlight></codeline>
<codeline lineno="88"><highlight class="normal"></highlight></codeline>
<codeline lineno="89" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_hash_1a95bfc303b2f9bd554e89861fde71d819" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_hash_1af11c61d44d987ef8d0b348ff05086c2d" kindref="member">is_hash_allowed</ref>(self,<sp/>hashes:<sp/>Optional[Hashes])<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="95"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>hashes.is_hash_allowed(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_hash_1ae7e414a393542b28b4075a89772f0dac" kindref="member">name</ref>,<sp/>hex_digest=self.value)</highlight></codeline>
...
<codeline lineno="99"><highlight class="normal"></highlight><highlight class="keyword">class<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file" kindref="compound">MetadataFile</ref>:</highlight></codeline>
...
<codeline lineno="102" refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file_1a3c4b397f9aa3247504fabec18458f7f6" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/>hashes:<sp/>Optional[Dict[str,<sp/>str]]</highlight></codeline>
<codeline lineno="103"><highlight class="normal"></highlight></codeline>
<codeline lineno="104"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal">__post_init__(self)<sp/>-&gt;<sp/>None:</highlight></codeline>
<codeline lineno="105"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file_1a707293d845bb3f041386d8d98d0b7dce" kindref="member">hashes</ref><sp/></highlight><highlight class="keywordflow">is</highlight><highlight class="normal"><sp/></highlight><highlight class="keywordflow">not</highlight><highlight class="normal"><sp/></highlight><highlight class="keywordtype">None</highlight><highlight class="normal">:</highlight></codeline>
...
<codeline lineno="120"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1a3ebb07fce552d4df63838fd4f369a694" kindref="member">_clean_url_path_part</ref>(part:<sp/>str)<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="128"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1af5f353c1bf88f7e928b795c8e0e48784" kindref="member">_clean_file_url_path</ref>(part:<sp/>str)<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="145"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1a3cd2defa48dbe923c5432a749995cdeb" kindref="member">_clean_url_path</ref>(path:<sp/>str,<sp/>is_local_path:<sp/>bool)<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="167"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1afd05275427ba2e4837200910c000c27e" kindref="member">_ensure_quoted_url</ref>(url:<sp/>str)<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="182"><highlight class="normal"></highlight><highlight class="keyword">class<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link" kindref="compound">Link</ref>(<ref refid="classpip_1_1__internal_1_1utils_1_1models_1_1_key_based_compare_mixin" kindref="compound">KeyBasedCompareMixin</ref>):</highlight></codeline>
...
<codeline lineno="197"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal">__init__(</highlight></codeline>
...
<codeline lineno="240"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self._parsed_url<sp/>=<sp/>urllib.parse.urlsplit(url)</highlight></codeline>
...
<codeline lineno="243"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self._url<sp/>=<sp/>url</highlight></codeline>
...
<codeline lineno="248"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self._hashes<sp/>=<sp/>hashes_from_link</highlight></codeline>
...
<codeline lineno="250"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self._hashes<sp/>=<sp/>{**hashes,<sp/>**hashes_from_link}</highlight></codeline>
<codeline lineno="251"><highlight class="normal"></highlight></codeline>
<codeline lineno="252"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self.comes_from<sp/>=<sp/>comes_from</highlight></codeline>
<codeline lineno="253"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self.requires_python<sp/>=<sp/>requires_python<sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/>requires_python<sp/></highlight><highlight class="keywordflow">else</highlight><highlight class="normal"><sp/></highlight><highlight class="keywordtype">None</highlight><highlight class="normal"></highlight></codeline>
<codeline lineno="254"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self.yanked_reason<sp/>=<sp/>yanked_reason</highlight></codeline>
<codeline lineno="255"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self.metadata_file_data<sp/>=<sp/>metadata_file_data</highlight></codeline>
<codeline lineno="256"><highlight class="normal"></highlight></codeline>
<codeline lineno="257"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>super().__init__(key=url,<sp/>defining_class=Link)</highlight></codeline>
<codeline lineno="258"><highlight class="normal"></highlight></codeline>
<codeline lineno="259"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self.cache_link_parsing<sp/>=<sp/>cache_link_parsing</highlight></codeline>
<codeline lineno="260" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a31467d7dee6bea2bf2d424955adbdc99" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a032877ccd8569fff4ce9225a3b75454d" kindref="member">egg_fragment</ref><sp/>=<sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a876c6555cea8ad9a3cf8bc7a2f1be2fb" kindref="member">_egg_fragment</ref>()</highlight></codeline>
...
<codeline lineno="275"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>url<sp/>=<sp/><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1afd05275427ba2e4837200910c000c27e" kindref="member">_ensure_quoted_url</ref>(urllib.parse.urljoin(page_url,<sp/>file_url))</highlight></codeline>
...
<codeline lineno="289"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>metadata_file_data<sp/>=<sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file" kindref="compound">MetadataFile</ref>(<ref refid="namespacepip_1_1__internal_1_1models_1_1link_1af0325b9911c920f9377d8bad1580e5ad" kindref="member">supported_hashes</ref>(metadata_info))</highlight></codeline>
...
<codeline lineno="292"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>metadata_file_data<sp/>=<sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file" kindref="compound">MetadataFile</ref>(</highlight><highlight class="keywordtype">None</highlight><highlight class="normal">)</highlight></codeline>
...
<codeline lineno="327"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>url<sp/>=<sp/><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1afd05275427ba2e4837200910c000c27e" kindref="member">_ensure_quoted_url</ref>(urllib.parse.urljoin(base_url,<sp/>href))</highlight></codeline>
...
<codeline lineno="340"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>metadata_file_data<sp/>=<sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file" kindref="compound">MetadataFile</ref>(</highlight><highlight class="keywordtype">None</highlight><highlight class="normal">)</highlight></codeline>
...
<codeline lineno="348"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>metadata_file_data<sp/>=<sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file" kindref="compound">MetadataFile</ref>(<ref refid="namespacepip_1_1__internal_1_1models_1_1link_1af0325b9911c920f9377d8bad1580e5ad" kindref="member">supported_hashes</ref>({hashname:<sp/>hashval}))</highlight></codeline>
...
<codeline lineno="355"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>metadata_file_data<sp/>=<sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_metadata_file" kindref="compound">MetadataFile</ref>(</highlight><highlight class="keywordtype">None</highlight><highlight class="normal">)</highlight></codeline>
...
<codeline lineno="365"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal">__str__(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
<codeline lineno="366"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1afbf7631c356c23c439f39b35407161dd" kindref="member">requires_python</ref>:</highlight></codeline>
...
<codeline lineno="370"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1aed0fb4d4320bf51a309c719ef452ec7f" kindref="member">comes_from</ref>:</highlight></codeline>
...
<codeline lineno="373"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>redact_auth_from_url(str(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ab3314b2581efb7fe79fe569bb8451d0e" kindref="member">_url</ref>))</highlight></codeline>
<codeline lineno="374"><highlight class="normal"></highlight></codeline>
<codeline lineno="375"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal">__repr__(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
...
<codeline lineno="379" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a6a4e9c09f8076390a11cc9b3fe51aede" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1af67004cdb29d12b7420984c694262af3" kindref="member">url</ref>(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
<codeline lineno="380"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ab3314b2581efb7fe79fe569bb8451d0e" kindref="member">_url</ref></highlight></codeline>
...
<codeline lineno="383" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a5fb02f5a5a42909c89a18745b74cf998" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a5fb02f5a5a42909c89a18745b74cf998" kindref="member">filename</ref>(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
<codeline lineno="384"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>path<sp/>=<sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a30f454216dcb615e3ed986238490f180" kindref="member">path</ref>.rstrip(</highlight><highlight class="stringliteral">&quot;/&quot;</highlight><highlight class="normal">)</highlight></codeline>
...
<codeline lineno="389"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>netloc,<sp/>user_pass<sp/>=<sp/>split_auth_from_netloc(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a3b75bb1dffe191f8f61239e8af2135cc" kindref="member">netloc</ref>)</highlight></codeline>
...
<codeline lineno="397" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a72e9faf9a2a5f838cfdce89db07e3150" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a6542bec4aeec14279b094156837dedea" kindref="member">file_path</ref>(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
<codeline lineno="398"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>url_to_path(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1af67004cdb29d12b7420984c694262af3" kindref="member">url</ref>)</highlight></codeline>
...
<codeline lineno="401" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a0086cb599d01ffeffa03c0c35ab85a42" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a3bb795cdf98672f4e084566820e6c7f7" kindref="member">scheme</ref>(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
<codeline lineno="402"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a2bc6f4e878cb4031b3e1a0da05f7c982" kindref="member">_parsed_url</ref>.scheme</highlight></codeline>
...
<codeline lineno="409"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a2bc6f4e878cb4031b3e1a0da05f7c982" kindref="member">_parsed_url</ref>.netloc</highlight></codeline>
...
<codeline lineno="419" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a800ca5662fff90f5fbc245e1218a5528" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a638d7375efa13338c3579494c34ed159" kindref="member">ext</ref>(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
<codeline lineno="420"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a09fc0c6b6ee11bd18101e0faba1389b1" kindref="member">splitext</ref>()[1]</highlight></codeline>
...
<codeline lineno="423" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a1453871423228f04baaa00bb3ecc2594" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a1453871423228f04baaa00bb3ecc2594" kindref="member">url_without_fragment</ref>(self)<sp/>-&gt;<sp/>str:</highlight></codeline>
<codeline lineno="424"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>scheme,<sp/>netloc,<sp/>path,<sp/>query,<sp/>fragment<sp/>=<sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a2bc6f4e878cb4031b3e1a0da05f7c982" kindref="member">_parsed_url</ref></highlight></codeline>
...
<codeline lineno="434" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ac92716c3f3ae7898cd2b9c8879c40875" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a876c6555cea8ad9a3cf8bc7a2f1be2fb" kindref="member">_egg_fragment</ref>(self)<sp/>-&gt;<sp/>Optional[str]:</highlight></codeline>
<codeline lineno="435"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/>match<sp/>=<sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a95651e61aa9f23805824835c9d4c086e" kindref="member">_egg_fragment_re</ref>.search(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ab3314b2581efb7fe79fe569bb8451d0e" kindref="member">_url</ref>)</highlight></codeline>
...
<codeline lineno="442"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/></highlight><highlight class="keywordflow">not</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a28a8618d3d7451a8becd34ec8fead66d" kindref="member">_project_name_re</ref>.match(project_name):</highlight></codeline>
...
<codeline lineno="466"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">if</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1abac655fca8b079dae2a59e2c721bdd48" kindref="member">metadata_file_data</ref>.hashes<sp/></highlight><highlight class="keywordflow">is</highlight><highlight class="normal"><sp/></highlight><highlight class="keywordtype">None</highlight><highlight class="normal">:</highlight></codeline>
<codeline lineno="467"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link" kindref="compound">Link</ref>(metadata_url)</highlight></codeline>
<codeline lineno="468"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link" kindref="compound">Link</ref>(metadata_url,<sp/>hashes=self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1abac655fca8b079dae2a59e2c721bdd48" kindref="member">metadata_file_data</ref>.hashes)</highlight></codeline>
<codeline lineno="469"><highlight class="normal"></highlight></codeline>
<codeline lineno="470" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1adc3aa52207f953fd0e556419536aab35" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1adc3aa52207f953fd0e556419536aab35" kindref="member">as_hashes</ref>(self)<sp/>-&gt;<sp/>Hashes:</highlight></codeline>
<codeline lineno="471"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/><ref refid="classpip_1_1__internal_1_1utils_1_1hashes_1_1_hashes" kindref="compound">Hashes</ref>({k:<sp/>[v]<sp/></highlight><highlight class="keywordflow">for</highlight><highlight class="normal"><sp/>k,<sp/>v<sp/></highlight><highlight class="keywordflow">in</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ac6c7c3c27a572112017ac715263e88ec" kindref="member">_hashes</ref>.items()})</highlight></codeline>
...
<codeline lineno="474" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a9d79621efd16f7c320ee3fdd6d8585b5" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ad47729bb335f34a5bb12295126e11342" kindref="member">hash</ref>(self)<sp/>-&gt;<sp/>Optional[str]:</highlight></codeline>
<codeline lineno="475"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>next(iter(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ac6c7c3c27a572112017ac715263e88ec" kindref="member">_hashes</ref>.values()),<sp/></highlight><highlight class="keywordtype">None</highlight><highlight class="normal">)</highlight></codeline>
...
<codeline lineno="478" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a5dc7a1b7027fc46fd6ed6b697233ce1a" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ada3d19424c3602c613c30f87d60f9ccf" kindref="member">hash_name</ref>(self)<sp/>-&gt;<sp/>Optional[str]:</highlight></codeline>
<codeline lineno="479"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>next(iter(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ac6c7c3c27a572112017ac715263e88ec" kindref="member">_hashes</ref>),<sp/></highlight><highlight class="keywordtype">None</highlight><highlight class="normal">)</highlight></codeline>
...
<codeline lineno="493" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a5dd1bbaac3ddd31fcbd9581c2be36a69" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a5dd1bbaac3ddd31fcbd9581c2be36a69" kindref="member">is_wheel</ref>(self)<sp/>-&gt;<sp/>bool:</highlight></codeline>
<codeline lineno="494"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a638d7375efa13338c3579494c34ed159" kindref="member">ext</ref><sp/>==<sp/>WHEEL_EXTENSION</highlight></codeline>
...
<codeline lineno="500"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a3bb795cdf98672f4e084566820e6c7f7" kindref="member">scheme</ref><sp/></highlight><highlight class="keywordflow">in</highlight><highlight class="normal"><sp/>vcs.all_schemes</highlight></codeline>
...
<codeline lineno="507" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1aa12e1776af173c655789509d5e8cfb43" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1aa12e1776af173c655789509d5e8cfb43" kindref="member">has_hash</ref>(self)<sp/>-&gt;<sp/>bool:</highlight></codeline>
<codeline lineno="508"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>bool(self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ac6c7c3c27a572112017ac715263e88ec" kindref="member">_hashes</ref>)</highlight></codeline>
<codeline lineno="509"><highlight class="normal"></highlight></codeline>
<codeline lineno="510" refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a64e9674633663980e1fd39dc35994d16" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1a718bd5e4de87bbcafbce081ac161f09e" kindref="member">is_hash_allowed</ref>(self,<sp/>hashes:<sp/>Optional[Hashes])<sp/>-&gt;<sp/>bool:</highlight></codeline>
...
<codeline lineno="516"><highlight class="normal"><sp/><sp/><sp/><sp/><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/>any(hashes.is_hash_allowed(k,<sp/>v)<sp/></highlight><highlight class="keywordflow">for</highlight><highlight class="normal"><sp/>k,<sp/>v<sp/></highlight><highlight class="keywordflow">in</highlight><highlight class="normal"><sp/>self.<ref refid="classpip_1_1__internal_1_1models_1_1link_1_1_link_1ac6c7c3c27a572112017ac715263e88ec" kindref="member">_hashes</ref>.items())</highlight></codeline>
<codeline lineno="517"><highlight class="normal"></highlight></codeline>
<codeline lineno="518"><highlight class="normal"></highlight></codeline>
<codeline lineno="519"><highlight class="normal"></highlight><highlight class="keyword">class<sp/></highlight><highlight class="normal"><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1___clean_result" kindref="compound">_CleanResult</ref>(NamedTuple):</highlight></codeline>
...
<codeline lineno="546" refid="classpip_1_1__internal_1_1models_1_1link_1_1___clean_result_1a62a495ad0cf090532fca52c51a6f3011" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/>query:<sp/>Dict[str,<sp/>List[str]]</highlight></codeline>
<codeline lineno="547"><highlight class="normal"><sp/><sp/><sp/><sp/>subdirectory:<sp/>str</highlight></codeline>
<codeline lineno="548" refid="classpip_1_1__internal_1_1models_1_1link_1_1___clean_result_1aee204b566ccaf5882d11ee43812eb55b" refkind="member"><highlight class="normal"><sp/><sp/><sp/><sp/>hashes:<sp/>Dict[str,<sp/>str]</highlight></codeline>
<codeline lineno="549"><highlight class="normal"></highlight></codeline>
<codeline lineno="550"><highlight class="normal"></highlight></codeline>
<codeline lineno="551"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1a45f41cb2eb4ca3e2c2bd6727ad59363c" kindref="member">_clean_link</ref>(link:<sp/>Link)<sp/>-&gt;<sp/>_CleanResult:</highlight></codeline>
...
<codeline lineno="569"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/><ref refid="classpip_1_1__internal_1_1models_1_1link_1_1___clean_result" kindref="compound">_CleanResult</ref>(</highlight></codeline>
...
<codeline lineno="578"><highlight class="normal"></highlight><highlight class="keyword">def<sp/></highlight><highlight class="normal"><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1ada2fcb1e55c2c728f9cde3698221810f" kindref="member">links_equivalent</ref>(link1:<sp/>Link,<sp/>link2:<sp/>Link)<sp/>-&gt;<sp/>bool:</highlight></codeline>
<codeline lineno="579"><highlight class="normal"><sp/><sp/><sp/><sp/></highlight><highlight class="keywordflow">return</highlight><highlight class="normal"><sp/><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1a45f41cb2eb4ca3e2c2bd6727ad59363c" kindref="member">_clean_link</ref>(link1)<sp/>==<sp/><ref refid="namespacepip_1_1__internal_1_1models_1_1link_1a45f41cb2eb4ca3e2c2bd6727ad59363c" kindref="member">_clean_link</ref>(link2)</highlight></codeline>
    </programlisting>
    <location file="microservicio_data_stream/venv/Lib/site-packages/pip/_internal/models/link.py"/>
  </compounddef>
</doxygen>
